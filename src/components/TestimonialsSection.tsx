  ...
  return <section className="py-20 px-4 bg-gradient-to-b from-transparent to-orange-50/30">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Join 10K+ Creators Earning with Insty</h2>
