      ...
      <div className="container mx-auto">
        ...
        <div className="relative overflow-hidden">
          <div className="flex animate-scroll space-x-6">
            {[...testimonials, ...testimonials].map((testimonial, index) => <div key={`${testimonial.name}-${index}`} className="p-6 rounded-2xl hover:scale-105 transition-all duration-300 flex-shrink-0 w-80 bg-white/80 backdrop-blur-sm border-2 border-white/40 shadow-sm">
