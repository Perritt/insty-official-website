        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="hidden md:block">
              <h1 className="text-lg font-bold bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Insty</h1>
              <p className="text-xs text-muted-foreground/60">AI-Powered Bio Links That Earn You Money</p>
            </div>
          </div>
